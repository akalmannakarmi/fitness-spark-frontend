...
const features: Feature[] = [
  {
    ...
    description:
      "Tailored to your goals – whether you're bulking, cutting, or maintaining.",
  },
  {
    title: "Tasty, Healthy Recipes",
    description:
      "Fuel your body with meals that are both nutritious and delicious.",
  },
  {
